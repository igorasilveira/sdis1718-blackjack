...
public class MyServer {
    ...
    public void createContexts() {
        ...
        HttpContext hc1 = server.createContext("/users", new UsersHandler());

        hc1.setAuthenticator(new BasicAuthenticator("USERS") {
            @Override
            ...
            try {
                ...
                switch (requestMethod) {
                    case METHOD_GET:
                        ...
                        break;
                    case METHOD_POST:
                        System.out.println("received users/POST from " +  he.getRemoteAddress().getHostName());
                        headers.set(HEADER_ALLOW, ALLOWED_METHODS);
                        ...
                        if (DATABASE.insertUser(jsonObject.getString("username"), password, salt)) {
